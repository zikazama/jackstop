...
const SlotMachine: React.FC<SlotMachineProps> = ({
  ...
  return (
    <div className="bg-black bg-opacity-50 rounded-lg p-8 mb-6 border border-red-800">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-white mb-2">Mesin Slot 3 Digit</h2>
        <p className="text-red-300">Perhatikan: Peluang menang sengaja dibuat kecil</p>
      </div>

      {/* Slot Machine Display */}
      <div className="bg-gray-900 rounded-lg p-6 mb-6 border-2 border-yellow-600">
      ...
      <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
        <h3 className="text-lg font-bold text-white mb-3 text-center">Tabel Pembayaran</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
          <div className="text-center p-2 bg-gray-800 rounded">
            <div className="text-lg mb-1">7️⃣7️⃣7️⃣</div>
